...
import as3java.util.ArrayList;
import as3java.util.Iterator;
import as3java.util.List;
...
public class AbstractSVGList {
     ...
     */
    protected function doParse(value:String, builder:ListHandler):void {
    	throw new Error("abstract class");
    }
     ...
     */
    protected function setAttributeValue(value:String):void {
    	throw new Error("abstract class");
    }
     ...
     */
    protected function createDOMException(type:int, key:String,
                                                       args:Object):Error {
                                                       	throw new Error("abstract class");
                                                       }
     ...
     *   list.
     */
    protected function initializeImpl(newItem:Object):SVGItem { 
        ...
        var item:SVGItem = removeIfNeeded(newItem);
     ...
     */
    protected function getItemImpl(index:int):SVGItem {
        revalidate();
     ...
     */
    protected function insertItemBeforeImpl(newItem:Object, index:int):SVGItem {
     ...
     */
    protected function replaceItemImpl(newItem:Object, index:int):SVGItem {
     ...
     *   than or equal to <code>numberOfItems</code>.
     */
    protected function SVGItem removeItemImpl(index:int) throws DOMException {
        revalidate();
        ...
        var item:SVGItem = (SVGItem)itemList.remove(index);
     ...
     *   list.
     */
    protected function appendItemImpl(newItem:Object):SVGItem {
     ...
     */
    protected function removeIfNeeded(newItem:Object):SVGItem {
        var item:SVGItem;
    ...
    protected function revalidate():void {
        ...
        try {
            var builder:ListBuilder = new ListBuilder();

            doParse(getValueAsString(), builder);

            var parsedList:List = builder.getList();
            if (parsedList != null) {
                clear(itemList);
            }
            itemList = parsedList;
     ...
     * given list.
     */
    protected function setValueAsString(value:List):void {
        var finalValue:String = null;
        var it:Iterator = value.iterator();
        if (it.hasNext()) {
            var item:SVGItem = (SVGItem) it.next();
            var buf:StringBuffer = new StringBuffer( value.size() * 8 );
     ...
     */
    public function itemChanged():void {
        resetAttribute();
    }
     ...
     * the list.
     */
    protected function resetAttribute(item:SVGItem):void {
        var newValue:String = getValueAsString() + getItemSeparator() + item.getValueAsString();
     ...
     */
    protected function removeItem(item:SVGItem):void {
     ...
     */
    protected function clear(list:List):void {
        if (list == null) {
            return;
        }
...
/**
    ...
    protected class ListBuilder implements ListHandler {
         ...
         */
        public function startList():List {
            list = new ArrayList();
        }
         ...
         */
        public function item(item:SVGItem):void {
